...
public class Contact {
	...
	public String toString() {
		//fill the code
		String tmp="";
		tmp=tmp+tmp.format("%-15s %-15s %-20s %-15s %-15s %-15s %s", this.getName(),this.getCompany(),this.getTitle(),this.getMobile(),this.getAlternateMobile(),this.getEmail(),sdf.format(this.getDateCreated()));
		return tmp;
	}
